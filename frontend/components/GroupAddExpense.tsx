...
// If user a pays 100 and split equally between himsself and b and then user b pays 100 and split equally with a all the amount should be settled up right? This is happening only in the case of simplify mode and not in raw. I am not saying it isnt correct but we can make it better by knowing internally that no ones anything to anyone in the group and display that.